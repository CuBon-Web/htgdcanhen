...
@section('js')
    ...
    // Trường hợp riêng: validate input[type=file] (ảnh)
    if (input.type === 'file' && v.selector === 'input[name="image"]') {
        // Kiểm tra nếu có file mới
        const hasFile = input.files && input.files.length > 0;
        // Kiểm tra nếu đã có ảnh cũ trong DOM
        const oldImage = document.querySelector('#img')?.getAttribute('src');
        const hasOldImage = oldImage && oldImage !== 'https://s.udemycdn.com/course/750x422/placeholder.jpg';
        ...
        continue; // qua validate file xong rồi, khỏi check nữa
    }
        ...
        <div class="container">
            <div class="become-a-teacher__top">
                <div class="section-title-two text-center sec-title-animation animation-style1">
                    <h2 class="section-title-two__title title-animation">Chỉnh sửa: {{$course->name}}
                    </h2>
                </div>
            </div>
            ...
            <form action="{{ route('postCourse') }}" method="post" enctype="multipart/form-data">
                @csrf
                  <input type="number" value="{{$course->id}}" name="id_course" hidden>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                ...
                                                <div class="contact-three__input-box">
                                                    <input type="text" name="name" value="{{$course->name}}" placeholder="Nhập tên khóa học...">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                ...
                                                <div class="contact-three__input-box">
                                                    <select name="category" id="">
                                                        ...
                                                        @foreach ($category as $item)
                                                             <option value="{{$item->id}}" {{$course->category == $item->id ? 'selected' : ''}}>{{languageName($item->name)}}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                ...
                                                <div class="contact-three__input-box">
                                                    <input type="number" value="{{$course->price}}" name="price" value="0">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                ...
                                                <div class="contact-three__input-box">
                                                    <input type="number" value="{{$course->discount}}" name="discount" value="0">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <label for="upload">Click Upload Ảnh
                                                            <input type='file' id="upload" name="image" value="{{ old($course->images) }}" >
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="become-a-teacher__right">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                ...
                                                <div class="contact-three__input-box">
                                                    <input type="text" name="so_buoi" value="{{$course->thickness}}" placeholder="Vd: 12">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <h4 class="contact-three__input-title">Số bài học</h4>
                                                <div class="contact-three__input-box">
                                                    <input type="text" name="so_bai_hoc" value="{{$course->ingredient}}" placeholder="VD: 34">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
