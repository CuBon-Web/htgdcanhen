                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="contact-three__input-box">
                                <input type="text" name="name" value="{{$test->name}}" placeholder="Nhập tên tài liệu...">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="contact-three__input-box">
                                <select name="category" id="">
                                    ...
                                    @foreach ($cate as $item)
                                            <option value="{{$item->id}}" {{$item->id == $test->cate_id ? 'selected' : ''}}>{{($item->name)}}</option>
                                    @endforeach
                        ...
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="thumb">
                                        <img id="img"
                                            src="{{ $test->image ? url( $test->image) : 'https://s.udemycdn.com/course/750x422/placeholder.jpg' }}" />
                        ...
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="contact-three__input-box">
                                 <textarea name="description" placeholder="Nhập nội dung..." class="ckeditor">{{$test->description}}</textarea>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12">
                            ...
                            @php
                                ...
                                $document = $test->file;
                                $getContent = $test->type;
                            @endphp
                            <div id="tai-lieu">
                                <tai-lieu  :initial-tasks='@json($noidungtest)'
        :initial-document='@json($document)' 
        :initial-type='@json($getContent)'></tai-lieu>
                            </div>
                        </div>
                    </div>
