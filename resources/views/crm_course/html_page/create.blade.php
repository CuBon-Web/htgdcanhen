    ...
    <div class="form-layouts-area">
        <div class="container-fluid">
            <div class="card-box-style">
                ...
                <form action="{{ route('html-pages.store') }}" method="POST">
                    @csrf
                    <div class="pb-24">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="Nếu bỏ trống sẽ tự tạo từ tiêu đề">
                                @error('slug')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <input type="hidden" name="content_html" id="content_html_hidden" value="{{ old('content_html') }}">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                ...
                                <a href="{{ route('html-pages.index') }}" class="btn btn-secondary">Hủy</a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('js_crm_course')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Render ngay lần đầu nếu có dữ liệu cũ
            renderPreview();
