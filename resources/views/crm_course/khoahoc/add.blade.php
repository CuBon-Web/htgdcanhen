                            ...
                            <div class="col-lg-3">
                                <div class="edit-profile-content card-box-style">
                                    ...
                                    <div class="save-update text-center">
                                        <button type="submit" class="btn btn-success me-2">Đăng khóa học</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="so_buoi"
                                                            placeholder="Vd: 12">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="so_bai_hoc"
                                                            placeholder="VD: 34">
                                                    </div>
                                                </div>
