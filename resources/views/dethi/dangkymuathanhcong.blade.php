...
<section class="page-header">
        ...
        <div class="container">
            <div class="page-header__inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Đăng ký mua đề thi thành công</h2>
     ...
     <section class="team-details">
        <div class="container">
            <div class="row">
                ...
                <p>Bạn đã đăng ký thành công đề thi <b>{{$dethi->title}}</b></p>
                <b>Bước 1:</b>
               ...
               <b>Bước 3:</b>
               <p>Đợi chúng tôi mở khóa đề thi cho bạn hoặc theo dõi qua đường dẫn: <a  href="{{route('khoiTaoDeThi')}}">Bấm để xem</a></p>
