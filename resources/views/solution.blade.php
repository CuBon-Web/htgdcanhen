                ...
                <div class="breadcrumb-inner text-start">
                    ...
                    <nav class="edu-breadcrumb-nav">
                        <ol class="edu-breadcrumb d-flex justify-content-start liststyle">
							...
							<li class="breadcrumb-item"><a href="{{route('listSolution')}}">Lịch Khai Giảng</a></li>
                            <li class="separator"><i class="ri-arrow-drop-right-line"></i></li>
    ...
    <div class="container">
       <div class="row g-5">
          ...
          <div class="col-lg-9 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <h3 class="title" style="font-size: 20px; text-align: center; color: #00b58c; font-weight: 700;"><a href="{{route('detailSolution',['slug'=>$solution->slug])}}">{{$solution->name}}</a></h3>
            <div class="table-responsive">
                <img src="{{$solution->images}}" alt="" style="margin-bottom:20px;"> 
                <br>
