      ...
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-3"><h4 class="card-title">Thêm mới bộ đề</h4></div>
...
components: {
  ...
  methods: {
    ...mapActions(["saveQuizTypeCategory", "loadings","listQuizCategoryMain","findQuizCategory"]),
    choisefile(e){
