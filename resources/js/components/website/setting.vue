        ...
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body" >
                ...
                <div class="form-group">
                  <label>Mô tả phần điểm khác biệt trang chủ</label>
                  <vs-input
                    type="text"
                    size="default"
                    class="w-100"
                ...
                <div class="form-group">
                  <label>Video giới thiệu</label>
                  <vs-input
                    type="text"
                    size="default"
                    class="w-100"
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                      <label>Ảnh giới thiệu</label>
                      <image-upload type="avatar" v-model="objData.linkpopup" :title="'footer_content'"></image-upload>
                    </div>
                  </div>
                <div class="row">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label>Ảnh phần điểm khác biệt(Ảnh trang chủ: 500x675px)</label>
                      <image-upload type="avatar" v-model="objData.fax" :title="'footer_content'"></image-upload>
                    </div>
                  </div>
                </div>
