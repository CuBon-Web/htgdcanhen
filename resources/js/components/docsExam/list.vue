        ...
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <router-link class="nav-link" :to="{name:'add_docs_exam'}">
              ...
              <vs-table max-items="10" pagination :data="list">
                ...
                <template slot-scope="{data}">
                  <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="tr.id">
                      <router-link :to="{name:'edit_docs_exam',params:{id:tr.id}}">
                        <vs-button
                          vs-type="gradient"
                          size="lagre"
                          color="success" 
...
export default {
  ...
  methods: {
    ...mapActions(["listDocsExam","deleteDocsExamId", "loadings"]),
    closePop(event) {
      this.listCategory();
    ...
    destroy(){
      this.loadings(true);
      this.deleteDocsExamId({id:this.id_item})
      .then(response => {
        this.listCategory()
        this.loadings(false);
