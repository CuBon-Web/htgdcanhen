...
export default {
  ...
  data() {
    return {
      init: {
        ...
        toolbar1: "undo redo | styleselect | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | link image | forecolor backcolor | code | tiny_mce_wiris_formulaEditor tiny_mce_wiris_formulaEditorChemistry",
        toolbar2: "print preview media | fullscreen",
        image_advtab: true,
        height: this.height,
        menubar: false,
        statusbar: false,
  ...
  methods: {
    loadFontAwesome() {
      ...
      // Load TinyMCE icons từ CDN
      if (!window.tinymce) {
        const tinymceIcons = document.createElement('script');
        tinymceIcons.src = 'https://cdn.tiny.cloud/1/no-api-key/tinymce/6/icons/default/icons.min.js';
        tinymceIcons.onload = () => console.log('TinyMCE icons loaded');
        document.head.appendChild(tinymceIcons);
      }
    },
