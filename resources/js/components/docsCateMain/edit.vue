...
export default {
  ...
  methods: {
    ...mapActions(["editDocsCategoryIdMain","saveDocsCategoryMain", "loadings"]),
    nameImage(event) {
    ...
    editDocsCategoryIdMains(){
      this.loadings(true);
      this.editDocsCategoryIdMain(this.objData).then(response => {
        this.loadings(false);
