<template>
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title" >Danh sách tài liệu</h4>

            <router-link class="nav-link" :to="{name:'createDocument'}">
...
export default {
  ...
  watch: {},
  methods: {
    ...mapActions(['listDocumentList','destroyDocumentList','loadings']),
    listProducts(){
      this.loadings(true);
      this.listDocumentList({ keyword: this.keyword })
      .then(response => {
          this.loadings(false);
    ...
    destroy(){
      this.destroyDocumentList(this.objDel).then(response => {
        this.listProducts();
