                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-6 col-lg-6">
                            <div class="form-group">
                              ...
                              <vs-select class="selectExample" v-model="detail.test_id" placeholder="Danh mục"
                                autocomplete>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <vs-select class="selectExample" v-model="objData.category" placeholder="Danh mục"
                ...
                <vs-select-item value="0" text="Không cấp học" />
                <vs-select-item :value="item.id" :text="JSON.parse(item.name)[0].content" v-for="(item, index) in cate"
                  :key="'f' + index" />
              </vs-select>
            </div>
            <div class="form-group">
              <label>Lớp học</label>
              <vs-select class="selectExample" v-model="objData.type_cate" placeholder="Lớp học"
                :disabled="type_cate.length == 0" @change="findCategoryTypeTwo()">
                <vs-select-item :value="item.id" :text="JSON.parse(item.name)[0].content"
                  v-for="(item, index) in type_cate" :key="'v' + index" />
              </vs-select>
            </div>
