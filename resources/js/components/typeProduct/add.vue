        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-3">
                  <h4 class="card-title">Thêm mới lớp học</h4>
                </div>
                ...
                <div class="col-md-3">
                  <vs-select
                    ...
                    placeholder="Ngôn ngữ lớp học"
              ...
              <form class="forms-sample">
                <div class="form-group">
                  <vs-input
                    ...
                    font-size="40px"
                    label-placeholder="Tên lớp học"
                  />
                </div>
                <div class="form-group">
                  <vs-select class="selectExample" v-model="objData.cate_id" placeholder="Cấp học">
                  <vs-select-item
                    :value="0"
                    text="Cấp học"
                  />
...
export default {
  ...
  methods: {
    ...
    saveEdit() {
      this.errors = [];
      if(this.objData.name[0].content == '') this.errors.push('Tên lớp học không được để trống');
      ...
      if (this.errors.length > 0) {
        ...
        this.saveTypeCate(this.objData)
          .then(response => {
            ...
            this.$success("Thêm lớp học thành công");
            this.$router.push({ name: "list_type_cate" });
          })
          .catch(error => {
            this.loadings(false);
            this.$error("Thêm lớp học thất bại");
          });
      }
    },
    listLang() {
