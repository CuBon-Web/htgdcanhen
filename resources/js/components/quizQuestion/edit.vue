...
export default {
  ...
  methods: {
    ...mapActions(["saveQuizQuestion","listQuizExam", "loadings","listQuizCategory","editQuizQuestionId","findPartExam"]),
    nameImage(event) {
    ...
    editQuizQuestionIds(){
      this.loadings(true);
      this.editQuizQuestionId(this.objData).then(response => {
        this.loadings(false);
