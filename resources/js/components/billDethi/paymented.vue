<template>
    <!-- partial -->
    <div>
        <h3 class="page-title">Đơn hàng đề thi đã thanh toán</h3>
        <div class="row">
                ...
                <div class="row" v-if="list.length == 0">
                  ...
                  <div class="col-md-4">
                    <div class="mb-0 flex-grow">
                      ...
                      <p class="mb-0 font-weight-light">Đơn hàng đã thanh toán là đơn hàng mà<br> đang ở trạng thái đã thanh toán<br></p>
                    </div>
                  </div>
                  <div class="col-md-4">
  ...
  export default {
    ...
    methods: {
      ...
      listBillDethis() {
        this.loadings(true);
        this.listBillDethi({ keyword: this.keyword,status:1 })
        .then(response => {
            this.loadings(false);
