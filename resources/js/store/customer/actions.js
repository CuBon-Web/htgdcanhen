...
export const resetPass  = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/customer/resetPass', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
...
export const destroyCustomer  = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.get('/api/customer/delete/'+ opt.id).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
...
export const detailResult  = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.get('/api/customer/result/'+ opt.id).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
