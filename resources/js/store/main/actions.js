...
export const listSocicalFeedback  = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.get('/api/website/list-socicalfeedback', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
...
export const saveSocicalFeedback  = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/website/socicalfeedback', opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
