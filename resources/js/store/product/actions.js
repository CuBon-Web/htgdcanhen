...
export const saveTest = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/product/create-test',opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
...
export const listTest = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.post('/api/product/list-test',opt).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
...
export const editIdTest = ({commit},opt) => {
    return new Promise((resolve, reject) => {
        HTTP.get('/api/product/edit-test/'+ opt.id).then(response => {
            return resolve(response.data);
        }).catch(error => {
            return reject(error);
        })
